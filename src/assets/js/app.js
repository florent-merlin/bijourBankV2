...
// 2)constructeur permettant de créer des objets pour formater des nombres en fonction de la locale
function money(montant) {
	return new Intl.NumberFormat('fr-FR', { style: 'currency', currency: 'EUR' }).format(montant);
}

// 3) recuperer et injecter les données dans le HTML
...
// 4) fonction pour creer l'operation -- & -- recuperation des valeurs du template
...
// 5) recuperer et injecter les données ds le header pour definir l'entete
